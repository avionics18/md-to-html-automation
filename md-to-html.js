...
async function main() {
    ...
    if (useInline) {
        inlineCSS =
            '<style>body{font-family:Inter,sans-serif}img{max-width:100%;margin:2rem auto;display:block}code{font-family:JetBrains Mono}blockquote{background-color:var(--bs-secondary-bg-subtle);border-left:5px solid var(--bs-secondary);padding:1rem}blockquote p:last-child{margin-bottom:0}ol ol,ol ul,ul ol,ul ul{margin-bottom:1rem}table{--bs-table-color-type:initial;--bs-table-bg-type:initial;--bs-table-color-state:initial;--bs-table-bg-state:initial;--bs-table-color:var(--bs-emphasis-color);--bs-table-bg:var(--bs-body-bg);--bs-table-border-color:var(--bs-border-color);--bs-table-accent-bg:transparent;--bs-table-striped-color:var(--bs-emphasis-color);--bs-table-striped-bg:rgba(var(--bs-emphasis-color-rgb),.05);--bs-table-active-color:var(--bs-emphasis-color);--bs-table-active-bg:rgba(var(--bs-emphasis-color-rgb),.1);--bs-table-hover-color:var(--bs-emphasis-color);--bs-table-hover-bg:rgba(var(--bs-emphasis-color-rgb),.075);vertical-align:top;border-color:var(--bs-table-border-color);width:100%;margin-bottom:1rem}table>:not(caption)>*>*{color:var(--bs-table-color-state,var(--bs-table-color-type,var(--bs-table-color)));background-color:var(--bs-table-bg);border-bottom-width:var(--bs-border-width);box-shadow:inset 0 0 0 9999px var(--bs-table-bg-state,var(--bs-table-bg-type,var(--bs-table-accent-bg)));padding:.5rem}table>tbody{vertical-align:inherit}table>thead{vertical-align:bottom}.super-heading{background-color:var(--bs-primary-bg-subtle)}#content h1{font-weight:900}#content h1,#content h2,#content h3{border-bottom:1px solid var(--bs-border-color);font-weight:600}#content h1,#content h2,#content h3,#content h4,#content h5{margin-bottom:1.5rem;padding:1rem 0}#content img{border:1px solid var(--bs-border-color)}@media screen and (width>=992px){#toc{max-height:600px;font-size:14px;overflow:auto}}pre code.hljs{border-radius:var(--bs-border-radius);padding:1rem}</style>';
